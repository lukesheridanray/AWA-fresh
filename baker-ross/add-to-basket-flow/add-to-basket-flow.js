...
exp.vars = {
    dummyIframe: $('<iframe src="" class="awa-dummy"></iframe'),
    loading: $('<div class="awa-loading"></div>')
};

// Styles
// String containing the CSS for the experiment
exp.css = ' \
.awa-loading { position: fixed; top: 45%; left: 45%; z-index: -1; width: 10%; height: 90px; margin: 0 auto; background-color: rgba(255,255,255,0.8); background-position: center; background-repeat: no-repeat; \
...
exp.func.successDropdown = function() {
    ...
    var dropdown = '<div class="awa-cart-dropdown block-content"> \
        <p class="awa-cart-dropdown__title">Your basket contains</p>' +
        cartContents.html() +
    '</div>';
    exp.vars.loading.removeClass('awa-loading--active');
...
// @params e - the event, type - string 'product' or 'boughttogether'
exp.func.addToBasket = function(e, $this, type) {
    ...
    exp.vars.loading.addClass('awa-loading--active');
