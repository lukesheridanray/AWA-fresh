...
console.log('Product listing - dev 0.1');

// Variables
// Object containing variables, generally these would be strings or jQuery objects
exp.vars = {
    'currentPage': 1,
    'numPages': $('.pages:eq(0) a').filter( function(){ return !$(this).hasClass('i-next'); } ).length
};
...
exp.init = function() {
    ...
    // Initiate infinate scroll plugin

    $('.category-products').infinitescroll({
        navSelector  : ".pages", 
        nextSelector : ".pages a:eq(0)",
        itemSelector : ".products-grid",
        maxPages     : exp.vars.numPages,
  ...
  localMode    : true
            ...
            exp.vars.currentPage++;

            alert(exp.vars.numPages);

            if(exp.vars.currentPage == exp.vars.numPages) {
