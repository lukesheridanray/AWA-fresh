...
//Style new layout
  $(".NC-row").css({"width":"100%","position":"relative","min-width":"700px"});
  $(".NC-heading, .topheading").css({"color":"#98002E","font-size":"16px", "width":"200px","padding-right":"10px","float":"left","padding-bottom":"20px"});
  $(".NC-content").css({"width":"400px","float":"left","margin-right":"300px","padding-bottom":"25px"});
  $(".NC-content-L").css({"float":"left"});
  $(".NC-content-R").css({"position":"absolute","right":"0px","width":"300px"});
  $(".NC-sumadjust").css({"position":"relative","padding-bottom":"15px"});
  $(".newSummary").css({"right":"-470px","width":"450px","bottom":"10px","border-left":"50px white solid","border-right":"solid white 170px","background-color":"white"});
  $(".NC-row-1 .NC-content-R").css({"top":"0px","padding-top":"20px","padding-left":"35px","background-image":"url('//cdn.optimizely.com/img/14847832/b5ad0505be384613b7faa794bc1717bf.png')","background-repeat":"no-repeat","height":"212px"});
  $(".newOptions").css({"width":"700px","font-size":"14px","margin-right":"0px","line-height":"20px","padding-bottom":"0"});
...
//Moving things
  ...
  $(".onestepcheckout-threecolumns").css({"visibility":"hidden","position":"absolute","top":"0"});
...
//END of delivery address checkboxes
...
$('.change_style').click(function(){$('.perfect_popup').css("display","block");});$('.perfect_close').click(function(){$('.perfect_popup').css("display","none");});
  
$('.perfect_close, .perfect_close2').css({ "width": "20px","height": "20px","position": "absolute","background": "#98002e","top": "-10px","right": "-10px","border-radius":"10px","color": "#fff","line-height": "20px","text-align": "center","text-transform": "full-width","font-size": "11px","cursor": "pointer"});
  
$('.perfect_popup, .perfect_popup2').css({"border": "2px solid #98002e","border-radius": "5px","background": "#fff","position": "fixed","z-index": "999","top": "40%","left": "35%","margin-left": "-12px","width": "30%","padding":"15px","text-align":"center","font-size":"18px"});
  
//END of delivery comments checkbox  
...
// ** LOOP **
// 1st listen to see if billing address should be expanded
...
$(".onestepcheckout-place-order-message").css({"width":"400px","float":"left"});
  ...
  if ($(".links .last a").text() == "Log Out") {$(".newOptions").css({"width":"400px","font-size":"14px","margin-right":"0px"});} else {$(".newOptions").css("width","700px");}
  //$(".allow-test-seal").css({"position":"relative","left":"10px"});
  $("NC-row-5").css("overflow","visible");
...
function expandCheck2 () {
  ...
  $(".newOptions").html(" ");
    ...
    $("<div class='warningText' style='display:none;'>Message warning text goes here</div><div class='showOptions'><div id='newDelivery'><a href='#join_form'><div id='dropDown' style='font-size:14px; font-style: italic; border:1px #DDD solid; padding:7px; position:relative; margin:0 0 18px 0; width:400px;'><span id='newDate'></span><span id='newMethod'></span><span id='newPrice'></span><div id='arrow' style='position:absolute; top:0px; right:0px;'><select style='border:0px; margin:0px; padding:0px;'></select></div></div></a><div class='awatick'> Beautifully packaged</div><div class='awatick'>Delivered with our <a class='change_styleB' href='javascript:;'>Perfection Guarantee</a></div></div><div class='perfect_popup2' style='display:none;'><div class='perfect_popup_in'><a class='perfect_close2' href='javascript:;'>X</a><h4>PERFECTION GUARANTEE</h4><p>Your Bettys parcel is carefully packed by hand here in Yorkshire, to ensure it stays perfect. In the unlikely event that your goods are not fresh and perfect on arrival, we GUARANTEE to replace or refund at your convenience.</p></div></div>").appendTo(".newOptions");
...
$(".onestepcheckout-comments").css({"display":"none"});  
...
$("#delComments").click(function() {
    if($(this).is(":checked"))
    {
        $(".onestepcheckout-comments").css({"display":"block"});
    }
