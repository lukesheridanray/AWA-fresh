...
var exp = function($) {
    ...
    */
	...
	exp.init = function() {
        ...
        var discount = parseFloat($(".content .badge-4").first().text().match(/\d+/)[0]);
        var currentPrice = parseFloat($(".content .price-amount").first().text().substring(1));
        ...
        $(".content .pricing").first().html(newPrices);

        $("#AWA-current-price").html("&pound" + currentPrice.toFixed(2));
        $("#AWA-was-price").html("Was &pound" + wasPrice.toFixed(2));
        $("#AWA-discount-price").html("Save &pound" + discount.toFixed(2));
