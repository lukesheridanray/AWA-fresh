                        ...
                        <div class='nav-panel-column'>\
                            <ul>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
                                    <a class='nav-anchor  ' href='https://store.canon.de/kameras/'>\
                                        <span>Kameras</span>\
                                    </a>\
                                </li>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
                                    <a class='nav-anchor  ' href='https://store.canon.de/fotospeicher/'>\
                                        <span>Fotospeicher</span>\
                                    </a>\
                                </li>\
                            </ul>\
                        </div>\
                ...
                <li class='AWA-menu-item primary-navigation-item'>\
                    ...
                    <div class='nav-panel xs-md-open-by-default'>\
                        <div class='nav-panel-column'>\
                            <ul>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
                                    <a class='nav-anchor  ' href='https://store.canon.de/objektive/'>\
                                        <span>Objektive</span>\
                                    </a>\
                                </li>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
                ...
                <li class='AWA-menu-item primary-navigation-item'>\
                    ...
                    <div class='nav-panel xs-md-open-by-default'>\
                        <div class='nav-panel-column'>\
                            <ul>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
                                    <a class='nav-anchor  ' href='https://store.canon.de/drucker-faxsysteme/'>\
                                        <span>Drucker & Faxsysteme</span>\
                                    </a>\
                                </li>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
