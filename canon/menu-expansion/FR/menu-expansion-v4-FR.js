                        ...
                        <div class='nav-panel-column'>\
                            <ul>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
                                    <a class='nav-anchor  ' href='https://store.canon.fr/appareils-photo/'>\
                ...
                <li class='AWA-menu-item primary-navigation-item'>\
                    ...
                    <div class='nav-panel xs-md-open-by-default'>\
                        <div class='nav-panel-column'>\
                            <ul>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
                                    <a class='nav-anchor  ' href='https://store.canon.fr/objectifs/'>\
                                        <span>Objectifs</span>\
                                    </a>\
                                </li>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
                ...
                <li class='AWA-menu-item primary-navigation-item'>\
                    ...
                    <div class='nav-panel xs-md-open-by-default'>\
                        <div class='nav-panel-column'>\
                            <ul>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
                                    <a class='nav-anchor  ' href='https://store.canon.fr/imprimantes-et-fax/'>\
                                        <span>Imprimantes et Fax</span>\
                                    </a>\
                                </li>\
                                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
