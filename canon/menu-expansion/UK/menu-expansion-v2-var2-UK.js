...
var exp = function($) {
    ...
    exp.log("Menu Expansion v2 - UK - var 2");
    ...
    exp.vars = {
        menu:   "<li class='AWA-menu-item primary-navigation-item  no-children'>\
				    <div class='primary-navigation-content '>\
				        <a class='primary-navigation--anchor ' href='https://store.canon.co.uk/cameras/'>\
				        	Cameras</a>\
				    </div>\
				</li>\
				<li class='AWA-menu-item primary-navigation-item  no-children'>\
				    <div class='primary-navigation-content '>\
				        <a class='primary-navigation--anchor ' href='https://store.canon.co.uk/lenses/'>\
				        	Lenses</a>\
				    </div>\
				</li>\
				<li class='AWA-menu-item primary-navigation-item  no-children'>\
				...
				<li class='AWA-menu-item primary-navigation-item  no-children'>\
				    <div class='primary-navigation-content '>\
				        <a class='primary-navigation--anchor ' href='https://store.canon.co.uk/printers-faxes/'>\
				        	Printers & Faxes</a>\
				    </div>\
				</li>\
				<li class='AWA-menu-item primary-navigation-item  no-children'>\
				    ...
				    <div class='nav-panel xs-md-open-by-default'>\
				        <div class='nav-panel-column'>\
				            <ul>\
				                ...
				                <li class='secondary-nav-item hover-nav-item has-sub-nav'>\
				                    <a class='nav-anchor  ' href='https://store.canon.co.uk/presenter/'>\
