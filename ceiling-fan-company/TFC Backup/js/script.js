...
$(function () {
    ...
    $(".CurrencyList").before("<a href='#' class='currency-selector'><span class='more-icon icon-chevron-down pull-right'></span></a>");
    ...
    $(".FindByCategory li").prepend('<i class="icon-chevron-right"></i>');
    ...
    function toggleChevron(icon) {
        ...
        switch(true) {
            case (chevron.hasClass("icon-chevron-down")):
                ...
                break;
            case (chevron.hasClass("icon-chevron-up")):
                chevron.removeClass("icon-chevron-up").addClass("icon-chevron-down");
                break;
            case (chevron.hasClass("icon-chevron-right")):
                chevron.removeClass("icon-chevron-right").addClass("icon-chevron-left");
                break;
            case (chevron.hasClass("icon-chevron-left")):
                chevron.removeClass("icon-chevron-left").addClass("icon-chevron-right");
                break;
        }
    }
