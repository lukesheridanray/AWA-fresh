	...
	exp.init = function() {
		...
		if ($('.ProductMain').length > 0) {
			...
			if ($.trim($('.VariationProductSKU').text()).substring(0, 2) == "11") {
				$('.BulkDiscountLink').after("<div style='clear:bother'></div><div id='show-dr'><a id='add-dr' href='#'>Add drop rod?</a></div>");
			...
			$('#add-ck').click(function(e) {
				...
				$.ajax({
				    ...
				    success: function(data) {
				    	...
				    	$('#productDetailsAddToCartForm3 .Label.QuantityInput').attr('style', 'color: green; width: 138px').text("Kit Quantity:");
				    	$('#productDetailsAddToCartForm .Label.QuantityInput').attr('style', 'color: green').text("Fan Quantity:");
				    	$('.productAddToCartRight').append($('#AWA-warranty'));
				    	...
				    	// Formatting
				    	 $('#productDetailsAddToCartForm3 .name:contains("Kit Colour:")').parent().parent().attr('style', 'margin-left: -199px !important');
