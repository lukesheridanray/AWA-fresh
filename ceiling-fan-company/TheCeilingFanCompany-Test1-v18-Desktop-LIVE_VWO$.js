  ...
  //}
	...
	exp.init = function() {
		...
		if (window.location.pathname == "/") {
			...
			vwo_$(".ProductCompareButton").on('change', function() {
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="white"]', function() {
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="remote-complete"]', function() {
				if (vwo_$(this).is(':checked')) {
					vwo_$('.ProductList').find('li').each(function() {
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="LED Option"]', function() {
				if (vwo_$(this).is(':checked')) {
					vwo_$('.ProductList').find('li').each(function() {
						var category = vwo_$(this).find('.AWA-almafi-title').text();
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="remote-compatible"]', function() {
				if (vwo_$(this).is(':checked')) {
					vwo_$('.ProductList').find('li').each(function() {
						var category = vwo_$(this).find('.AWA-almafi-title').text();
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="energy saving"]', function() {
				if (vwo_$(this).is(':checked')) {
					vwo_$('.ProductList').find('li').each(function() {
						var category = vwo_$(this).find('.AWA-almafi-title').text();
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="0-136"]', function() {
				if (vwo_$(this).is(':checked')) {
					vwo_$('.ProductList').find('li').each(function() {
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="137-205"]', function() {
				if (vwo_$(this).is(':checked')) {
					vwo_$('.ProductList').find('li').each(function() {
						var price = vwo_$(this).find('.AWA-price').text().slice(1);
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="206-273"]', function() {
				if (vwo_$(this).is(':checked')) {
					vwo_$('.ProductList').find('li').each(function() {
						var price = vwo_$(this).find('.AWA-price').text().slice(1);
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="274-342"]', function() {
				if (vwo_$(this).is(':checked')) {
					vwo_$('.ProductList').find('li').each(function() {
						var price = vwo_$(this).find('.AWA-price').text().slice(1);
			...
			vwo_$('.AWA-filter').on('change', 'input:checkbox[value="343-410"]', function() {
				if (vwo_$(this).is(':checked')) {
					vwo_$('.ProductList').find('li').each(function() {
						var price = vwo_$(this).find('.AWA-price').text().slice(1);
		...
		if (vwo_$('.ProductMain').length > 0) {
			...
			vwo_$('#AWA-product-tabs').on('click', '.AWA-tab', function() {
			...
			vwo_$('.VariationProductPrice').bind("DOMSubtreeModified",function(){
				...
				if (window.location.pathname == "/vienna-white/" || window.location.pathname == "/vienna-stainless-steel/" || window.location.pathname == "/fantasia-vienna-ceiling-fan-polished-brass-42/") {
					vwo_$('.productOptionViewRadio').on('change', 'input:radio[value=105]', function(e) {
				        if (vwo_$(this).is(':checked')) {
				        	setTimeout(function() {
					...
					vwo_$('.productOptionViewRadio').on('change', 'input:radio[value=120]', function(e) {
				        if (vwo_$(this).is(':checked')) {
				        	setTimeout(function() {
			...
			vwo_$('.productAttributeConfigurablePickListSet').on('click', '.AWA-options a', function(e) {
				e.stopPropagation();
				e.preventDefault();
	...
	// if jQuery is not already used on the site use optimizely.vwo_$ instead
})(vwo_$);
