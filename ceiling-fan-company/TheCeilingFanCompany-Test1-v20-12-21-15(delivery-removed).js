/* REMOVE */
vwo_$("#Container").css({"display":"none"});
/* CUSTOM CODE */
setTimeout(function(){
  ...
  //}
	...
	exp.vars = {
		...
		nav: "<nav id='AWA-primary_nav_wrap'>\
			...
			</nav><div id='AWA-xmas'><strong>Tuesday 23rd December - last order date for despatch before Christmas!</strong><br>Orders can be placed securely after this date and will be shipped when we re-open on Monday 5th January</div>",
	...
	exp.init = function() {
		...
		function insertCategoryTitleAndKeepTitles() {
			...
			vwo_$(".Content .ProductList li").attr('style', 'height: 350px !important');
		}
