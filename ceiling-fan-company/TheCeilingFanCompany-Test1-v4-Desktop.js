	...
	exp.init = function() {
		...
		if ($('.ProductMain').length > 0) {
			...
			var priceSection = "<div id='AWA-product-section'>\
									<div class='AWA-product-info'><div style='clear: both'></div><div class='AWA-product-info-value'>&pound;" + youSaveAmount + "</div><label>You Save</label><div style='clear:both'></div>\
									<div class='AWA-product-info'><div class='AWA-product-info-value'>&pound;" + newPrice + "</div><label>Old Price</label><div style='clear:both'></div>\
									<div class='AWA-product-info'><div class='AWA-product-info-value'>&pound;" + oldPrice + "</div><label>New Price</label><div style='clear:both'></div>\
								<div>";
			...
			function populateFeatures() {
				...
				var roomSizeMessage = "Ideal for room size of "
