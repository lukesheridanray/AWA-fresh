	...
	exp.vars = {
		...
		nav: "<nav id='AWA-primary_nav_wrap'>\
				<ul>\
				  ...
				  <li><a id='AWA-tfr' href='http://www.theceilingfancompany.co.uk/fantasia-ceiling-fan-range/'>Fantasia\'s Ranges</a>\
		...
		homeCategories: "<div class='AWA-home-categories'>\
			...
			icons: "<div class='AWA-icons'>\
						...
						<div class='AWA-icon'>\
							...
							<div class='AWA-icon-box'>\
								...
								<p>You have a huge range of ceiling fan designs to choose from, some with light and others without, in styles ranging from contemporary to classic. Many fans are available in a choice of two sizes with several blade options, and you can also change the blade colours within each range.\
								</p>\
							</div>\
						</div>\
						<div class='AWA-icon'>\
			...
			installation: 	"<div id='AWA-installation'>\
								<img src='//cdn.optimizely.com/img/174847139/2e546aefe82b49cbba2e637c618f493f.jpg' width='892'>\
								<p>\
	...
	exp.init = function() {
	    ...
	    $('head').append('<style type="text/css">'+this.css+'</style>');
			...
			var fandata = {
			  ...
			  "Delta": { "Flush Mount":"", "Drop Mount":"Y", "Dual Mount":"", "Remote Control":"Included", "Light":"Included", "LED Option":"Y", "Low Energy Motor":"Y", "Speeds":6, "Size":"52\"/44\" or 1320cm/1120cm", "Warranty":"15 YEARS", "Bulb Type":"2 x G9", "Notes":"can be fitted flush if a flush mount kit is purchased"},
			  ...
			  "Omega": { "Flush Mount":"", "Drop Mount":"Y", "Dual Mount":"", "Remote Control":"Included", "Light":"Included", "LED Option":"Y", "Low Energy Motor":"Y", "Speeds":6, "Size":"52\"/44\" or 1320cm/1120cm", "Warranty":"", "Bulb Type":"2 X G9", "Notes":"can be fitted flush if a flush mount kit is purchased"},
		...
		function insertCategoryTitle() {
			console.log('insertCategoryTitle running');
		...
		if ($('.ProductMain').length > 0) {
			...
			if ($('.ProductTinyImageList li').length >= 5) {
			...
			var priceSection = "<div id='AWA-product-section'>\
									<div class='AWA-product-info'><div style='clear: both'><div class='AWA-product-info-value'>&pound;" + oldPrice + "</div><label>RRP Price</label><div style='clear:both'></div>\
									<div class='AWA-product-info'><div class='AWA-product-info-value'>&pound;" + newPrice + "</div><label>Our Price</label><div style='clear:both'></div>\
			...
			function populateFeatures() {
				...
				if ($('.AWA-newList li').length == 6) {
					$('.AWA-newList li').attr('style', 'margin-right: 26px; font-size: .85em;');
