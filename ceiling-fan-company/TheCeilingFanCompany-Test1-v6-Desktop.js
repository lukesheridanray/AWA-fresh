	...
	*/
	...
	exp.vars = {
		...
		phone: "<div class='AWA-phone-side'>\
					<h1 style='font-size: 25px; font-family: Arial; text-align: right; margin-top: 10px;'>Freephone: 08081684535</h1>\
				</div>",
		popularSearches: "<div style='clear: both'></div><div class='AWA-searches'>\
							<span id='AWA-popular-searches-text'>Popular searches:</span>\
							<a href='http://www.theceilingfancompany.co.uk/search.php?search_query=mayfair'> Mayfair</a>,\
							<a href='http://www.theceilingfancompany.co.uk/search.php?search_query=eurofans'> Eurofans</a>,\
							<a href='http://www.theceilingfancompany.co.uk/search.php?search_query=capri'> Capri</a>,\
							<a href='http://www.theceilingfancompany.co.uk/search.php?search_query=amalfi'> Amalfi</a>\
						</div>",
		...
		tagLineBox: "<div style='clear: both'></div><div class='AWA-tagline-box'>\
						...
						<div class='shh'>\
							\"Quiet, reliable and probably the only make of fan you would ever purchase.\"\
						</div>\
					</div>",
	...
	exp.init = function() {
		...
		if ($('.ProductMain').length > 0) {
			...
			var priceSection = "<div id='AWA-product-section'>\
									<div class='AWA-product-info'><div style='clear: both'><div class='AWA-product-info-value'>&pound;" + RRPPrice + "</div><label>RRP Price</label><div style='clear:both'></div>\
									<div class='AWA-product-info'><div class='AWA-product-info-value' id='AWA-our-price'>&pound;" + ourPrice + "</div><label>Our Price</label><div style='clear:both'></div>\
