	...
	exp.init = function() {
		...
		if ($('.ProductMain').length > 0) {
			...
			function populateFeatures() {
			    ...
			    $('.ProductThumb').nextUntil('#AWA-product-tabs').wrapAll("<div id='AWA-prod-right'></div>");
			    $('#AWA-prod-right').after("<div style='clear: both'></div>");
			}
			...
			$.ajax({
			    ...
			    success: function(data) {
			    	...
			    	$('#AWA-prod-right').append($('#AWA-warranty'));
