...
var exp = (function($) {
	...
	*/
	...
	.AWA-logo-side .value-prop p {\
		...
		background: -webkit-linear-gradient(top, #189B24, #229D2E);\
		background: -moz-linear-gradient(top, #189B24, #229D2E);\
		background: -ms-linear-gradient(top, #189B24, #229D2E);\
		background: -o-linear-gradient(top, #189B24, #229D2E);\
	...
	exp.init = function() {
		...
		if ($('.ProductMain').length > 0) {
			...
			console.log("Side products removed");
			...
			// // Add warranty info
			// $('.ProductDetailsGrid .DetailRow').last().after("<div id='AWA-warranty'><strong>Warranty: <span></span></strong><br>\"[Our Fantasia Ceiling fan] has served us well for about 20 years!\" -Mr Y from Y</div>");
		 ...
		 //    	if (newFanData.light && newFanData.light == "With light") {
			...
			// 	$('.ProductAddToCart .DetailRow').after("<div style='clear:bother'></div><div id='show-dr'><a id='add-dr' href='#'>Add drop rod?</a></div>");
