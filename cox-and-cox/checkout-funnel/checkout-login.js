...
exp.init = function() {
    ...
    // Global
    // Progress bar
    var progress = '<div class="progress-bar"><div class="steps-line "></div><div class="step-link login">Login</div><div class="step-link billing active">Billing information</div><div class="step-link delivery">Delivery</div><div class="step-link payment">Payment</div></div>';
