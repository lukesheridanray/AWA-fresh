...
// e) Apply the same rules to the Deliver to Different Address section.
    ...
    exp.init = function() {
        ...
        $('#billing-new-address-form > fieldset > ul > li:nth-child(8)').css('display', 'none')
        ...
        #billing-new-address-form > fieldset > ul > li.wide.meanbee-postcode-element, #billing-new-address-form > fieldset > ul > li:nth-child(8) > div:nth-child(2), #continue-btn, #billing-new-address-form > fieldset > ul > li:nth-child(3) > div.field.meanbee-postcode-element").hide();
        ...
        */
        var checkBillValInterval = setInterval(function(){
            if(
                ...
                $('#billing-new-address-form > fieldset > ul > li:nth-child(8) input').val() !== ''
            ) {
                validator.validate();
        ...
        */
        var checkShipValInterval = setInterval(function(){
            if(
                ...
                $('#shipping-new-address-form > fieldset > ul > li:nth-child(8) input').val() !== ''
            ) {
/*
