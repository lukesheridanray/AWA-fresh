...
*/
        ...
        selectAddress.click(function(e) {
            $("#billing-new-address-form > fieldset > ul > li:nth-child(6), #billing-new-address-form > fieldset > ul > li:nth-child(10) > div, #billing-new-address-form > fieldset > ul > li:nth-child(8), #billing-new-address-form > fieldset > ul > li:nth-child(7) ").show();
        });
...
waitForjQuery(1000);
/* MOVERESIZE */
vwo_$("#co-payment-form > fieldset:first-child > dl:first-child > dl:first-child > dt:first-child > label:last-child").css({"height":"31px","width":"1727px","top":-24,"left":-18,"zIndex":"auto","position":"relative","display":"block"});
/* MOVERESIZE */
vwo_$("#co-payment-form > fieldset:first-child > dl:first-child > dl:first-child > dt:nth-child(3) > label:last-child").css({"height":"33px","width":"1862px","top":-25,"left":"22px","zIndex":"auto","position":"relative","display":"block"});
