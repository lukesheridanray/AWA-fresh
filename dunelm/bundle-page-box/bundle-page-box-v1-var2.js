...
var exp = (function($) {
	...
	exp.log('Bundle Page Box v1 - var2');
	...
	*/
	...
	exp.init = function() {
		...
		// Get box title
		var title = $("h2.bdp-summary__title").first().text();

		// Hide box
		$(".bdp-summary.accordion").hide();

		// Insert original title
		$(".pdp-detail.bdp-main-col").prepend("<h2 class='page-heading' id='AWA-box-heading'>" + title + "</h2>");
	...
	$(document).ready(function() {
		exp.func.waitFor(function(){ return $(".accordion-content.bdp-summary__desc").length }, exp.init, 1000);
	});
