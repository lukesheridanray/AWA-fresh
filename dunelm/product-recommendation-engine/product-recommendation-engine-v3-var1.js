// 1.15.16 NOTE: For unknown reasons, IE wouldn't run the code inside the main IIFE. Taking it out of the IIFE seems to work fine.
...
exp.log('Product Recommendation Engine v2 - var1');
