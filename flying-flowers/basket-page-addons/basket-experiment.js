...
customDeleteLink();
        ...
        function customAddOnListener(checked) {
                $('.addAddonIcon').each(function(){
                    ...
                    current_addon.html('<img src="http://www.awa-digital.com/optimizely/flying-flowers/add-addon-off.gif" alt="">');
                    $('.addOnRow td:nth-child(even)').each(function(){
                        if($(this).html() === _this_addon_sku ) {
                            current_addon.html('<img src="http://www.awa-digital.com/optimizely/flying-flowers/add-addon-on.gif" alt="">');
                            return false;
                        }
                    });
                    ...
                    current_addon.bind('click',function() {
                      ...
                      if( $(this).html() !== '<img src="http://www.awa-digital.com/optimizely/flying-flowers/add-addon-on.gif" alt="">' && !$(this).hasClass('disableAddOn') ) {
               ...
               $(this).parent().bind('click',function(e) {
                 ...
                 if(vars.variation === 1) {
                   ...
                   FlyingFlowers.Utils.dialogue(
                      '<p class="modal-title">Make your gift extra special by adding optional extra treats</p>' +
                       cache_addons +
                   ...
                   FlyingFlowers.Utils.dialogue(
                      '<p class="modal-cross-button"><a href="/order/delivery/">X</a></p><p class="modal-title">Make your gift extra special by adding optional extra treats</p>' +
                       cache_addons +
                       '<div class="modal-buttons"><p class="modal-checkout-button fright"><a href="/order/delivery/"><img src="/static/images/checkoutSecurely.jpg?v=noev"></a></p>' +
                       '</div>'
                   );
                   ...
                   addon_imgs.each(function(){
                       ...
                       if(src.indexOf('Oscar_Bear') !== -1 ) {
                           _this.attr({'src':'http://www.awa-digital.com/optimizely/flying-flowers/products/teddy.jpg'});
                       }
                       else if(src.indexOf('desert_chocs') !== -1 ) {
                           _this.attr({'src':'http://www.awa-digital.com/optimizely/flying-flowers/products/dessert-choc.jpg'});
                       }
                       else if(src.indexOf('cont_chocs') !== -1 ) {
                           _this.attr({'src':'http://www.awa-digital.com/optimizely/flying-flowers/products/cont-choc.jpg'});
                       }
                       else if(src.indexOf('thorn_classics') !== -1 ) {
                           _this.attr({'src':'http://www.awa-digital.com/optimizely/flying-flowers/products/classic-choc.jpg'});
                       }
                       else if(src.indexOf('Guylian') !== -1 ) {
                           _this.attr({'src':'http://www.awa-digital.com/optimizely/flying-flowers/products/guylian.jpg'});
                       }
                       else if(src.indexOf('ft_egg-1') !== -1 ) {
                           _this.attr({'src':'http://www.awa-digital.com/optimizely/flying-flowers/products/egg.jpg'});
                       } else {
...
window.setTimeout(function(){$('.exp-add-on-container .addAddonIcon').removeClass('addAddon').removeClass('addItem');},200);
    }
};
