...
@media screen and (max-width: 991px) {\
  ...
  ";
        ...
        jQuery('body > div.wrapper > section > div > div > div > img').remove();
            ...
            // new text for hero.
                jQuery('.container').find('.col-md-6').prepend('\
                    <p style="font-size: 45px;">No lancets.<br> No routine finger pricking.<sup style= "font-size: 15px;">†</sup></p>\
                    <p style="margin: 40px 0;">The days of routine glucose testing with lancets, test strips and blood are over.<sup>1</sup></p>\
                    <p id="AWA-starter-pack-position">Get your Starter Pack today</p>\
                    </div>\
                ')
                // jQuery('.landing-page').before('<div class="AWA-quote-wrapper">\
                //       <p class="AWA-quote-life">"A small price for improving my long term health considering how much I spend on coffees, drinks and dinners out."<sup>6</sup></p>\
                //       </div>\
                //       ')


              //New hero img
                $('body > div.wrapper > section.hero.phase2.Dark > div > div > div:nth-child(1) > div > div').html('<p style="margin: 0; padding: 0;"><span class="big">for £159.95</span><br><span style="float: right" class="small">Incl. VAT</span></p>');
                jQuery('body > div.wrapper > section > div > div').append('<div class="col-md-6">\
                   <img class="reader-awa-libre" src="https://useruploads.visualwebsiteoptimizer.com/useruploads/232844/images/00f3dd46aaba1ab498a62c045c77368d_reader-for-libre.png">\
					<img id="img-guarantee-AWA" src="https://youcandoit.freestylediabetes.co.uk/wp-content/themes/youcandoit/assets/img/money_back_guarantee.png">\
                 </div>')
      $('footer').remove();
    ...
    <div class="AWA-quote-wrapper">\
          <p class="AWA-quote-life">"<i>A small price for improving my long term health<br>considering how much I spend on coffees, drinks and dinners out."<sup>**</sup></i></p>\
    <div class="AWA-we-work-img" style="     border: 1px dashed #ecce6c;   width: 100%; min-height: 65px;    margin-top: 8px;    padding-top: 5px;">\
...
<br/>3. The FreeStyle Libre Flash Glucose Monitoring System is indicated for measuring interstitial fluid glucose levels in people (age 4 and older) with diabetes mellitus. The indication for children (age 4 - 17) is limited to those who are supervised by a caregiver who is at least 18 years of age. A caregiver at least 18 years old is responsible for supervising, managing, and assisting the child in using the FreeStyle Libre system and interpreting its readings.</p>\
      ...
      jQuery('a.cta-button.buy').attr('id', 'id-for-awa-btn-nav');
