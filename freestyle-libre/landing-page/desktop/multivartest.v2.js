  ...
  ";
    ...
    exp.init = function() {
        ...
        jQuery('.container').find('.col-md-6').html('\
            ...
            <p>No lancets.* <br> No routine finger pricking.<sup>†</sup><br>Just a 1 second scan.</p>\
            <p>Get your Starter Pack today</p>\
            <div class="button-area col-md-6">\
                ...
                <div class="price pull-left">Price VAT incl:<span>for £159.95</span></div>\
                    ...
                    <img src="https://icons.iconarchive.com/icons/iconsmind/outline/24/Close-Window-icon.png">\
                      ...
                      <p style="padding-left: 7px; font-size: 17px;"">No VAT payable if you have Diabetes Mellitus<sup>4</sup>, or buying on behalf of someone aged 4+ with diabetes Mellitus<sup>4</sup></p>\
                    </div>\
                    <div class="AWA-VAT-text"><p class="click-info-here-AWA" style="display: inline-block; padding-left: 30px; margin-top: 0px; white-space: nowrap">With VAT RELIEF:<span> £133.29<sup style="width: 1px;">\
    ...
    //Changes to the HTML and images


// jQuery('.container').find('.col-md-6').html('\
//   <img src="https://useruploads.visualwebsiteoptimizer.com/useruploads/232844/images/9fbc7280bd8c95c83c9c87279887b95c_text_for_libre.png" alt="" class="img-responsive">\
//   <p>No lancets.* <br> No routine finger pricking.<sup>†</sup><br>Just a 1 second scan.</p>\
//   <div class="button-area col-md-8">\
//       <a href="http://www.freestylelibre.co.uk/products.html?utm_source=freestylediabetes&amp;utm_medium=referral&amp;utm_term=buy-now&amp;utm_content=button-1&amp;utm_campaign=libre" target="_blank" class="cta-button btn pull-left" data-track="send", "event", "cta - Default", "Buy Now", "Hero - Stories"">Buy Now</a>\
...
6.&nbsp;Online survey response from a customer. Data on file\
