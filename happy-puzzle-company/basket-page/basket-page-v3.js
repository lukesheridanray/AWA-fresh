...
console.log('Basket page v3 -  0.4');
...
exp.css = ' \
#recommended-modal-content { display: none; width: 980px; height: 360px; overflow: hidden; } \
.free-delivery-threshold-message { position: relative; top: -5px; clear: both; padding: 0; margin: 0; font-size: 20px; font-weight: bold; text-align: center; } \
.free-delivery-threshold-message .another_amount, .free-delivery-threshold-message .free_delivery_threshold { font-size: 20px; } \
...
\
.basket_voucher_message { width: 938px !important; position: relative; top: -10px; background: #ddd; font-weight: normal; padding: 0; } \
.basket_voucher_message a { color: #000 !important; } \
.basket_voucher_message .another_amount { position: relative; top: -4px; } \
.basket_voucher_message .another_amount, .basket_voucher_message .free_delivery_threshold { font-size: 18px; } \
\
...
.basket_info { position: relative; left: 330px; } \
.basket_info_summary_table .basket_info { left: 0px; } \
...
if (this.vars.recommendedProduct1.length) {
    ...
    $('#recommended-modal-content').html(
        ...
        '<p class="free-delivery-threshold-message">' +
        $('#ctl00_cphInnerMaster_spAnotherAmount').html() +
        '</p>'
    );
    ...
    // Make delivery option spans labels instead
