...
var exp = (function($) {
	...
	exp.log('Category Page v4 - Desktop');
	...
	*/
	...
	exp.init = function() {
	    ...
	    function mainPage() {
		    ...
		    $(".feature_link").parent().first().attr('style', 'border-left: solid 2px purple; background-color: #FEEBF9;');

		    if ($(".feature_link").parent().length == 1) {
		    	$(".feature_link").parent().first().attr('style', 'border-left: solid 2px purple; border-right: solid 2px purple; background-color: #FEEBF9;');
		    } else if ($(".feature_link").parent().length == 2) {
		    	$(".feature_link").parent(":eq(1)").attr('style', 'border-right: solid 2px purple; background-color: #FEEBF9;');
		    } else {
		    	$(".feature_link").parent(":eq(2)").attr('style', 'border-right: solid 2px purple; background-color: #FEEBF9;');
		    }
		    $(".feature_link").parent(":eq(1)").attr('style', 'background-color: #FEEBF9;');
		}
