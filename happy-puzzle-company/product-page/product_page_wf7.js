    ...
    console.log('Happy Puzzle Product Page experiment wf7 - 0.5');
    ...
    exp.vars = {
        ...
        'product_info_table'         : $('#ctl00_cphInnerMaster_tblProductInfo'),
    ...
    exp.init = function() {
        ...
        this.vars.product_info_table.after(this.vars.reviews_html);

        // Move product info to left column
        this.vars.product_info_table.insertAfter(this.vars.click_thumbnails_line);

        // Add money-back row after prod desc
