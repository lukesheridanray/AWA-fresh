...
var exp = function($) {
	...
	exp.init = function() {
        ...
        $("#AWA-right .txt-rgt").after("<div class='AWA-small'>You are about to be transferred to Sage Page who will process your credit card securely.</div><div class='AWA-small'>Details of the candidate(s) taking the courses will be confirmed after your order is complete.</div>");
        ...
        $("label:contains('Title')").parent().attr('style', 'padding-top: 8px;');

        $("p:contains('Please enter your billing details here')").attr('style', 'padding-right: 20px;');
        $("label:contains('House name or number')").parent().addClass("AWA-hnn");

        // AA11AA


        // Place "House name or number" under "Postcode"
