/* NOTE: Where should the Catering, Retail, and Manufacture links link to?  And "see a sample certificate" */
...
var exp = (function($) {
	...
	exp.vars = {
		...
		divider: 	"<div id='AWA-divider'>\
						FREE UK delivery and FREE instant download of your legally recognised certificate. <a href='#'>See a sample certificate</a>\
					</div>",
