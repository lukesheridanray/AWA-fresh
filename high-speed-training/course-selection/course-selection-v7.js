...
var exp = (function($) {
	...
	exp.vars = {
		headerMiddle: 	"<div id='AWA-header-middle'>\
							<p>High Quality Certificate Can be Used to Show Compliance with Training Requirements</p>\
							...
							<p id='AWA-header-last-line' style='display: none;'>\
								Start online now and complete at your own pace\
							</p>\
						</div>",
		headerBottom: 	"<h2 id='AWA-header-bottom'>Start online now and complete at your own pace</h2>",
		logoRow: 	"<div id='AWA-logos'>\
						...
						<div id='AWA-logos-right'>\
							<p class='AWA-logo-text'>\
								Accepted by Local Authorities / EHO Approved\
							</p>\
							<a href='../food-safety/eho-approved-training.aspx'><img id='AWA-approval-image' src='../assets/images/eho-approved.gif'></a>\
						</div>\
				</div>",
						...
						<div class='col-md-12'>\
							<div class='col-md-4 AWA-course'>\
								...
								<div class='AWA-product-desc'>\
									<p>\
										<span class='AWA-underline'>This course is right for you if...</span> you work in the food industry, but are not directly involved in the preparation or handling of high-risk food, or who only handle wrapped or pre-packaged food. E.g: \
									</p>\
									<ul>\
									...
									<p class='AWA-course-note AWA-cn1'>\
							...
							<div class='col-md-4 AWA-course'>\
								...
								<div class='AWA-product-desc'>\
									...
									<p class='AWA-course-note AWA-short AWA-cn2'>\
										Level 2 Food Hygiene Safety courses are available for:\
									</p>\
									<ul class='AWA-no-bullet'>\
										<li><a href='#' class='AWA-l2-links'>Catering</a></li>\
										<li><a href='#' class='AWA-l2-links'>Retail</a></li>\
										<li><a href='#' class='AWA-l2-links'>Manufacturing</a></li>\
									</ul>\
							...
							<div class='col-md-4 AWA-course'>\
								...
								<div class='AWA-product-desc'>\
									...
									<p class='AWA-course-note AWA-short AWA-cn3'>\
										Level 3 Food Hygiene Safety courses are available for:\
									</p>\
									<ul class='AWA-no-bullet'>\
										<li><a href='#' class='AWA-l3-links'>Catering</a></li>\
										<li><a href='#' class='AWA-l3-links'>Retail</a></li>\
										<li><a href='#' class='AWA-l3-links'>Manufacturing</a></li>\
									</ul>\
									<p class='AWA-course-note'>\
		...
		divider: 	"<div id='AWA-divider'>\
						Free UK delivery and Free instant download of your personalised certificate. <a id='AWA-sample' href='#'>See a sample certificate</a>\
					</div>",
		buttonSection: 	"<div id='AWA-button-section' class='row'>\
							<div class='col-md-12'>\
								<div class='col-md-4 AWA-button-col'>\
									...
									<a class='btn btn-large btn-green AWA-buy-button' href='#'>Buy Now »</a>\
									<p class='AWA-or'>OR</p>\
									<a class='btn btn-large btn-orange AWA-find-out-more AWA-fom1' href='http://www.highspeedtraining.co.uk/food-hygiene/choose-level-1.aspx'>Find out more »</a>\
								</div>\
								<div class='col-md-4 AWA-button-col'>\
									<a href='#' class='AWA-bulk'>Bulk / team Discounts</a>\
									<p class='AWA-price'>&pound;20 + VAT</p>\
		...
		tickMarks: 	"<div id='AWA-tick-marks' class='row'>\
						<div class='col-md-12'>\
							<ul class='icons-ul'>\
								<li><i class='icon-li icon-ok-sign'></i>All courses meet UK & EU legal requirements</li>\
	...
	exp.init = function() {
	    ...
	    $(".hero-header h1").text("FOOD HYGIENE Level 1, 2 or 3 - Start Learning Now");
	    $(".hero-header h2").hide();
		...
		$(".AWA-trigger-l2, .AWA-l2-links").click(function(e) {
			e.preventDefault();
			$('#AWA-level2').show();
			$('#__msg_overlay').show();
		});
		...
		$(".AWA-trigger-l3, .AWA-l3-links").click(function(e) {
			e.preventDefault();
			$('#AWA-level3').show();
			$('#__msg_overlay').show();
		});
