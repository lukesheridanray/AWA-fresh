...
var exp = (function($) {
	...
	exp.vars = {
		...
		level2: 	"<div class='product-price'>\
					...
					<p>\
 					...
 					<ul>\
 						<li><a href='#' class='AWA-mini-link'>Catering</a></li>\
 						<li><a href='#' class='AWA-mini-link'>Retail</a></li>\
 						<li><a href='#' class='AWA-mini-link'>Manufacturing</a></li>\
 					</ul>\
 					<p>\
	...
	exp.init = function() {
		...
		$("#A4, .AWA-mini-link").click(function(e) {
			e.preventDefault();
			$('#AWA-level2').show();
			$('#__msg_overlay').show();
		});
