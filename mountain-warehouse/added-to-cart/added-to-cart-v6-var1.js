	...
	*/
		...
		greenTicks: "<div class='row'>\
						...
						<div class='col-8 col-pad'>\
							<ul id='AWA-green-ticks'>\
								...
								<li id='AWA-standard-delivery'><span class='AWA-no-orphan1' id='AWA-no-wrap1'>FREE Standard</span><span class='AWA-no-orphan1'> Delivery &nbsp;&nbsp;<img src='//useruploads.visualwebsiteoptimizer.com/useruploads/27849/images/04093ff5c08067f0f0690307c8942c80_image_copy.png'></span></li>\
								<li id='AWA-exchanges'><span class='AWA-no-orphan2' id='AWA-no-wrap2'>FREE Exchanges & No Hassle</span><span class='AWA-no-orphan2'> Returns &nbsp;&nbsp;<img src='//useruploads.visualwebsiteoptimizer.com/useruploads/27849/images/04093ff5c08067f0f0690307c8942c80_image_copy.png'></span></li>\
							</ul>\
						</div>\
					</div>"
	};
	...
	exp.init = function() {
	    ...
	    function changeModal() {
	    	...
	    	var itemPrice = Number($.trim($(".now span[itemprop='price']").first().text()).substring(1));

	    	var basketValue = Number($("#hdnBasketValue").val().substring(1));
	    	...
	    	if (basketValue < 50) {
	    		...
	    		$("#AWA-standard-delivery").html("<span class='AWA-no-orphan1' id='AWA-no-wrap1'>FREE Next Day</span><span class='AWA-no-orphan1'> Delivery &nbsp;&nbsp;<img src='//useruploads.visualwebsiteoptimizer.com/useruploads/27849/images/04093ff5c08067f0f0690307c8942c80_image_copy.png'></span>");
	    	}
