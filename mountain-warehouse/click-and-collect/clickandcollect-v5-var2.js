...
var exp = (function($) {
	...
	exp.log('Click and Collect - v5 - var2');
	...
	*/
	...
	exp.vars = {
		bannerText: "<ul id='AWA-banner'>\
						<li class='AWA-1 AWA-not'><a href='#'>FREE DELIVERY over &pound;50</a></li>\
						<li class='AWA-line AWA-not'>|</li>\
						<li class='AWA-2 AWA-not'>FREE NEXT DAY DELIVERY over &pound;80</li>\
						<li class='AWA-line AWA-not'>|</li>\
						<li class='AWA-3 AWA-not'>CLICK & COLLECT<span class='AWA-to-stores'> to 186 stores nationwide</span></li>\
					</ul>\
					<ul id='AWA-banner2'>\
