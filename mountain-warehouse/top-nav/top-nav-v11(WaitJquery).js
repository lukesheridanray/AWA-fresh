...
var exp = function($) {
	...
	*/
	...
	exp.init = function() {
	    ...
	    console.log($("a.level1:contains('Kids')").html());
	    /* --- FOOTWEAR --- */
	    // Insert Footwear category
	    $("a.level1:contains('Kids')").parent().after(exp.vars.footwear);
	    ...
	    console.log($("a.level1:contains('Footwear')").html());
	    /* --- SKI --- */
	    // Move Ski category after footwear
	    $("#AWA-footwear").parent().after($("a.level1:contains('Ski')").parent());

	    console.log($("a.level1:contains('Ski')").html());
	    /* --- WALKING --- */
	   	// Insert Walking category after Ski
		$("a.level1:contains('Ski')").parent().after(exp.vars.walking);

		console.log($("a.level1:contains('Walking')").html());
	    /* --- Rucksacks --- */
	   	// Insert Rucksacks category after Walking
		$("a.level1:contains('Walking')").parent().after(exp.vars.rucksacks);

		console.log($("a.level1:contains('Rucksacks')").html());
		/* --- Sports --- */
		...
		/* --- CLEARANCE --- */
		$("a.level1:contains('Clearance')").text($("a.level1[href='http://www.mountainwarehouse.com/clearance/']").text().toUpperCase());
	...
	// Run the experiment
	exp.func.waitFor(function() { return $(".level2 a:contains('Ski Accessories')").length}, exp.init);
