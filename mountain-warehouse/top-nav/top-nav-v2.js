...
var exp = (function($) {
	...
	*/
	...
	exp.init = function() {
	    ...
	    $("a.level1[href='/kids/']").parent().after(exp.vars.footwear);
	    ...
	    $("#AWA-footwear").parent().after($("a.level1[href='/ski/']").parent());


	    /* --- WALKING --- */
	   	// Insert Walking category after Ski
		$("a.level1[href='/ski/']").parent().after(exp.vars.walking);
		...
		/* --- CLEARANCE --- */
		$("a.level1[href='/clearance/']").text($("a.level1[href='/clearance/']").text().toUpperCase());
