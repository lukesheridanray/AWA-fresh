	...
	*/
	...
	exp.init = function() {
	    ...
	    exp.func.waitFor( function() {
	    	return $("#AWA-footwear").length; 
	    }, footwear);


	    function footwear() {
	    	console.log('activating footwear');
	...
	// Run the experiment
	exp.func.waitFor(function() { return $("a.level1:contains('Ski')").length}, exp.init);
