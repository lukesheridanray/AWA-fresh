    ...
    'run': function() {
      ...
      console.log('v1.0.22');
        ...
        if( $('.deliveryBold').html().indexOf('Delivery to UK Mainland') !== -1 ) {
            ...
            $('.delivery_changelink').css({'position':'relative','top':'-15px'});
...
/*
<div class="saveForOptions"> \
  <a href="http://www.northernparrots.com/page/xt_orderform_additem/?sessionid='+vars.session_id+'&amp;index=&amp;sku='+sku[0].replace("/","").replace("prod","")+'&amp;quantity=1"><strong>Add To Basket</strong></a> \
</div> \
