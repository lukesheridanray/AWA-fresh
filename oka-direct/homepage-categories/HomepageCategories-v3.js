...
var exp = (function($) {
	...
	exp.log('Homepage Categories v3');
	...
	*/
	...
	exp.init = function() {
	    ...
	    var $newsletter = $('.span12').find('a[href$="/oka-newsletter/"]').first().parent().parent();
	    ...
	    // Insert mobile categories after "REQUEST A CATALOGUE" banner
 		$('a[href$="/en-GB/page/catalogue-request/"]').closest('.row').after(exp.vars.furnitureAccessories);
