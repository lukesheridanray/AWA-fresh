...
var exp = (function($) {
	...
	exp.log('Product Page Reviews - v1 - var2');
	...
	*/
	...
	exp.init = function() {
		...
		if ($.trim($(".prod-detail-rating").text()) != "") {
			$(".about .bliss.upper:contains('About')").before("<p id='AWA-random-review'>" + review + "</p>");
		...
		// Move review stars under "ABOUT" section
		$("#AWA-random-review").before($(".prod-detail-rating"));
