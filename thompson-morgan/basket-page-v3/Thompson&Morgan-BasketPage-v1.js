...
exp.vars = {
 ...
 \
    ...
    popup:  "<div id='AWA-popup'>\
                ...
                <div id='AWA-right'>\
                    <h1 id='AWA-title'>Blechnum brasiliense \'Volcano\'</h1>\
                    <h1 id='AWA-latin'>Dwarf Brazilian Tree Fern, Hard Fern</h1>\
                    <h3 id='AWA-category'>Hardy Perennial</h3>\
                    <ul id='AWA-features'>\
                        <li>New in 2015</li>\
                        <li>Hardy down to -5c in the UK</li>\
                    </ul>\
...
exp.init = function() {
	...
	// WaitFor JSON hander
  	...
  	var imageDataCallback = function() {
  		...
  		console.log(productData["t64856TM"]);
  	};
