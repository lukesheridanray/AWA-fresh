	...
	*/
	...
	exp.vars = {
		instructions: 	"<ul id='AWA-catalogue-instructions'>\
							...
							<li>Click on the X button to see thumbnails of all pages. Click on any thumbnail to advance to that page. <i>(where X = the thumbnail button in the menu)</i></li>\
						</ul>",
