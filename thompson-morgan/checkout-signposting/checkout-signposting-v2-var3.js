...
var exp = (function($) {
	...
	exp.log('Checkout Signposting - v2 - var3');
	...
	exp.css = '\
		...
		#AWA-csp-info {\
			...
			width: 180px;\
			margin-right: -10px;\
			background-image: url(//dd6zx4ibq538k.cloudfront.net/static/images/2841/6d9adeb923229acb1a3c2a2b53940c10_25_23.png);\
		...
		#cart-content .mini-basket {\
			background-image: url(//dd6zx4ibq538k.cloudfront.net/static/images/2841/6d9adeb923229acb1a3c2a2b53940c10_25_23.png) !important;\
			background-repeat: no-repeat;\
	...
	exp.init = function() {
		...
		if (!universal_variable.basket) {
			$(".AWA-csp-co").hide();
			$(".AWA-csp-info").attr('style', 'background-image: none;');
		}
