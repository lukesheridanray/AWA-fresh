...
console.info($('#nav-5').html());
if ($('#nav-5').html() == "Despatching <br> Now") {
    exp.log('Experiment failed a condition - Despatching Now already running');
    return false;
}
// Variables
