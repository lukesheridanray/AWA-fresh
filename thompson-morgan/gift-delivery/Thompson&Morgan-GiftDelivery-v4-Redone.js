...
var exp = (function($) {
	...
	*/
	...
	exp.init = function() {
	    ...
	    if ($(".delivery-dates-options:first-of-type").find("input:radio").length == 1) {
	    	$(".delivery-dates-options:first-of-type").find("input:radio.christmas").attr('checked','checked');
	    }
