...
.highlighted .qty-heading {\
    display: block;\
}\
.highlighted .buying-option-qty {\
    display: block;\
}\
.highlighted .promo {\
    display: block;\
...
.highlighted .buying-option-oldprice {\
    display: none;\
}\
#addBasketSuccessDIV {\
    z-index: 10000; \
...
exp.init = function() {
    ...
    $(document).ready(function () {
        ...
        displaying.html('Displaying <strong id="displaying">'+ displaying_max +'</strong> of '
            + displaying_max
            + ' products.');
