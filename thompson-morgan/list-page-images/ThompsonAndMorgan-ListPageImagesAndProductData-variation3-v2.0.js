function () {
	...
	var exp = (function($) {
		...
		exp.log('List Page Images & Product Data - 2.0 var 3');
		...
		exp.init = function() {
			...
			// WaitFor JSON hander
		  	...
		  	var conditionImage = function() {
			    imageData2 = imageData2 || undefined;
		  	...
		  	var imageDataCallback = function() {
		  		$('.resultSet .floatLeft').each(function() {
		            ...
		            if (imageData2[urlCode]) {
		            	var newImage = imageData2[urlCode];
		  ...
		  waitFor(conditionImage, imageDataCallback);
			...
			var conditionProductInfo = function() {
			    productInfo2 = productInfo2 || undefined;
		  	...
		  	var productInfoCallback = function() {
		    	...
		    	getNewData(productInfo2);

		    	function getNewData(productInfo2) {
		    		$('.floatRight.facetDescription .season').each(function() {
			    		...
			    		if (containsProductBullet == true && (containsRating == true || containsRating == false)) {
			    			...
			    			findAndApply($listing, productInfo2, urlCode);
			    ...
			    function findAndApply($listing, productInfo2, urlCode) {
	    			var newData = {};
	    			if (productInfo2[urlCode]) {
		    			newData.idealFor = productInfo2[urlCode]["ideal_for"].split(',').join(', ');;
	  	    			newData.hardiness = productInfo2[urlCode]["hardiness"];
	  	    			newData.sunShade = productInfo2[urlCode]["sun_shade"];
	  	    			newData.height = productInfo2[urlCode]["height"];
	  	    			newData.spread = productInfo2[urlCode]["spread"];
	  	    			newData.floweringMonths = productInfo2[urlCode]["flowering_months"].split(',').join(', ');
