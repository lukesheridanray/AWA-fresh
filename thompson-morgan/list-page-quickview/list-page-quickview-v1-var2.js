...
var exp = (function($) {
	...
	exp.log('List Page Quickview v1 - var2');
	...
	*/
	...
	exp.vars = {
		popup: 	"<div id='AWA-data-template'>\
					<div id='AWA-quick'><span id='AWA-quick-view'>QUICK VIEW</span>&nbsp;&nbsp;<a class='AWA-extra-view-all' href='#'>view all product details</a></div>\
					...
					<img id='AWA-large-image' src='http://www.tandmpics.com/e404/180.jpg'>\
					<ul id='AWA-dt-list'>\
					...
					<a class='AWA-extra-view-all' id='AWA-view-all2' href='#'>view all product details</a>\
				</div>"
	};
            ...
            if (productJSON) {
            	if (productJSON[productCode]) {
            		...
            		if (productJSON[productCode]["height"]) {
           			...
           			if (productJSON[productCode]["image_l_252"]) {
            			$("#AWA-large-image").attr('src', productJSON[productCode]["image_l_252"]);
            		} else {
