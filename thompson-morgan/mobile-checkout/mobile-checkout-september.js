...
';
      ...
      $('.subscriptionTable').hide();
			...
			$("#mainform").before("<a href='#' id='AWA-m-guest-checkout' class='AWA-m-new-button'>Im New</a>");
			$(".userDetails").hide();
...
<p>Copyright © Thompson &amp; Morgan, 2004-2016. All rights reserved.</p>\
	...
	');
	 ...
	 /*************-------------------------------------------------************/
		...
		/***
		step one: Move the my basket div to bottom right corner of page/////////
		***/
		$('#loginForm').after($('#headerBasket'));
		$('#headerBasket:first').hide();
