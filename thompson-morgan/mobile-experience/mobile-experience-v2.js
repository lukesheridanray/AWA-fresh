...
var exp = (function($) {
	...
	/* --- MOBILE NAVIATION --- */
		...
		if ($('#268917436').length) {
			...
			$(".addToBasket").attr('style', 'background-color: #B60718; background-image: none; text-indent: 0px; color: white; width: 146px; height: 35px !important; font-size: 90%; margin-top: 10px;');
		...
		if ($("h2:contains('Login to your account')").length) {
			this.loginCSS = '\
				...
				input[type=text], .product-additional-info input, .product-additional-info textarea, .tellafriend-portlet textarea, input[type=password] {\
					font-size: 150%;\
					width: 65%;\
				}\
				.dropDownField {\
				...
				.login-portlet input[type=text], .login-portlet input[type=password] {\
					width: 50%;\
				}\
				.AWA-m-new-button {\
					display: block;\
			...
			$(".userDetails").hide();
			$("#registration_submit").attr('style', 'background-color: #B60718; background-image: none; text-indent: 0px; color: white; width: 199px; height: 35px !important; font-size: 150%; margin-top: 10px; float: none !important;').attr('value', 'Continue Checkout');
			...
			$("#login_submit").attr('style', 'background-color: #B60718; background-image: none; text-indent: 0px; color: white; width: 199px; height: 35px !important; font-size: 150%; margin-top: 10px; float: none !important; margin-right: 0;').attr('value', 'Login');
