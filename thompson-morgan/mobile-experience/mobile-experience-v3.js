...
var exp = (function($) {
	...
	/* --- MOBILE NAVIATION --- */
		...
		if ($('#268917436').length) {
			...
			$(".addToBasket").attr('style', 'background-color: #B60718; background-image: none; text-indent: 0px; color: white; width: 100%; height: 65px !important; font-size: 200%;');
