function () {
	...
	var exp = (function($) {
		...
		*/
		...
		.modal-bg {\
		    display: none; background:rgba(0, 0, 0, 0.33); position:fixed; top:0; left:0; width:100%; height:100%; z-index:10;\
		}\
		#order-confirmation {\
		...
		exp.init = function() {
			...
			var bullet = "<img class='new-bullet' src='//dd6zx4ibq538k.cloudfront.net/static/images/2841/ab7ede086db991afec13a69727700b65_10_12.png'>";
