...
var exp = (function($) {
	...
	exp.log('Product Page v3.0 - var2');
	...
	*/
	...
	@media only screen and (max-device-width: 780px) {\
		.AWA-flowering-label, .AWA-flowering-data {\
			width: inherit;\
			display: inline;\
		}\
		.AWA-ideal-label, .AWA-ideal-data {\
			width: inherit;\
			display: inline;\
		}\
		.AWA-harvest-label, .AWA-harvest-data {\
			width: inherit;\
			display: inline;\
		}\
		.AWA-sowing-label, .AWA-sowing-data {\
			width: inherit;\
			display: inline;\
		}\
	}';
