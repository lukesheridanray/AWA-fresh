...
var exp = (function($) {
  ...
  exp.log('Product Page Tips - v4 - var1');
  ...
  */
  ...
  if (exp.condition && !exp.condition.length) {
  	...
  	if (window.location.href.indexOf("garden-supplies") > -1 || window.location.href.indexOf("seed") > -1) {
  		exp.log('Product Page Tips should not run on seeds or garden supplies - existing');
  		return false;
	}
