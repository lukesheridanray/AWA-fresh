...
var exp = (function($) {
  ...
  exp.log('Product Page Tips - v7 - var1');
  ...
  exp.init = function() {
    ...
    var whatThisMatch = [
      ...
      { regexCheck: /plug plant/i, header: "Plug plants",
        text: "These healthy baby plants have a strong root system and are ready to plant straight into hanging baskets and containers, or can be grown on for garden planting too, once all risk of frost has passed. Generally 6-8cm in height.",
        moreInfo: "For more information on how to grow plug plants please <a>click here.</a>", link: "http://www.thompson-morgan.com/plug-plants-video",
    ...
    // 11/15 padding fix (added 11/25 - unsure if this was needed)
