function () {
  ...
  #vm023-arrive-image {\
    position: relative;\
    background: url('//d1m54pdnjzjnhe.cloudfront.net/vanmeuwen/vm023/vm023-arrive-image.png') no-repeat;\
    width: 175px;\
    height: 264px;\
  }\
  ...
  var whatThisMatch = [
    { regexCheck: /garden(-| )ready/i, header: "Garden ready plug plants",
      ...
      imageLink: "//d1m54pdnjzjnhe.cloudfront.net/vanmeuwen/vm023/vm023_garden_ready.jpg"},
    ...
    { regexCheck: /tuber/i, header: "Tubers",
      ...
      imageLink: "//d1m54pdnjzjnhe.cloudfront.net/vanmeuwen/vm023/vm023_bulbs.jpg"},
    ...
    { regexCheck: /plug plant/i, header: "Plug plants",
      ...
      moreInfo: "For more information on how to grow plug plants please <a>click here.</a>", link: "http://www.thompson-morgan.com/plug-plants-video",
      imageLink: "//d1m54pdnjzjnhe.cloudfront.net/vanmeuwen/vm023/vm023_plug_tray_plants.jpg"},
    ...
    { regexCheck: /tray/i, header: "Plug tray plants",
      ...
      moreInfo: "For more information on how to grow plug plants please <a>click here.</a>", link: "http://www.thompson-morgan.com/plug-plants-video",
      imageLink: "//d1m54pdnjzjnhe.cloudfront.net/vanmeuwen/vm023/vm023_plug_plants.jpg"},
    ...
    { regexCheck: /potted/i, header: "Potted plants",
      ...
      imageLink: "//d1m54pdnjzjnhe.cloudfront.net/vanmeuwen/vm023/vm023_potted_plants.jpg"
    }
  ];
