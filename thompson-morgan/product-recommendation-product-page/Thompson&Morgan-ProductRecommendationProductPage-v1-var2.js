...
var exp = (function($) {
	...
	exp.log('Product Recommendation Product Page - v1-var2');
	...
	exp.init = function() {
		...
		if (recentlyViewed.length) {
			...
			for (var i = 0; i < recentlyViewed.length; i++) {
				$("#AWA-pp-viewed-entries").prepend("<div class='AWA-pp-rec'><a  class='AWA-pp-image-element' href='" + recentlyViewed[i].url + "'><img width='100' src='" + recentlyViewed[i].image + "'></a><br><div>" + recentlyViewed[i].form + "</div><a class='AWA-pp-rec-link' href='" + recentlyViewed[i].url + "'><span id='AWA-pp-rec-name" + i + "'></span></a><br><span class='AWA-pp-price'>" + recentlyViewed[i].price + "</span>");
