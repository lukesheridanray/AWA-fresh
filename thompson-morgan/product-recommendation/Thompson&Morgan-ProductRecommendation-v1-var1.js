...
var exp = (function($) {
	...
	exp.log('Product Recommendation - v1-var1');
	...
	*/
	...
	exp.init = function() {
		...
		if (recentlyViewed.length) {
			...
			for (var i = 0; i < recentlyViewed.length; i++) {
				$("#AWA-viewed-entries").prepend("<div class='AWA-rec'><a href='" + recentlyViewed[i].url + "'><img width='100' src='" + recentlyViewed[i].image + "'></a><br><span id='AWA-rec-name" + i + "'></span><br><span class='AWA-price'>" + recentlyViewed[i].price + "</span></div>");
