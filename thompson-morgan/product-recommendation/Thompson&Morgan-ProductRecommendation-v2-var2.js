...
var exp = (function($) {
	...
	exp.log('Product Recommendation - v2-var2');
	...
	*/
	...
	exp.init = function() {
		...
		if (recentlyViewed.length) {
			...
			for (var i = 0; i < recentlyViewed.length; i++) {
				$("#AWA-viewed-entries").prepend("<div class='AWA-rec'><a  class='AWA-image-element' href='" + recentlyViewed[i].url + "'><img width='100' src='" + recentlyViewed[i].image + "'></a><br><div>" + recentlyViewed[i].form + "</div><a class='AWA-rec-link' href='" + recentlyViewed[i].url + "'><span id='AWA-rec-name" + i + "'></span></a><br><span class='AWA-price'>" + recentlyViewed[i].price + "</span>");
