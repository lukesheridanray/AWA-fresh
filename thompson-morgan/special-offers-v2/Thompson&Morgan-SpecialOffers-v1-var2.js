...
var exp = (function($) {
	...
	exp.log('Special Offers - v1 - var2');
	...
	*/
	...
	exp.init = function() {
		...
		var bestSellerCallback = function(productArray, itemCount, id) {
		    ...
		    $(id + " .AWA-offer-box").prepend("<div class='AWA-view-all'><a class='AWA-view-all-link' href='" + itemCount.url + "'>view all " + itemCount.num + " items</a></div>");
