...
var exp = (function($) {
    ...
    */
    ...
    exp.vars = {
        ...
        newBottomSection:   "<div id='AWA-new-bottom' class='row'>\
                                <div id='AWA-new-bottom-left' class='col-sm-6 col-md-6 col-lg-6'>\
                                    <img id='AWA-umara-shoe' src='//useruploads.visualwebsiteoptimizer.com/useruploads/197399/images/3a084f4d5eee64349696cac8ddb71d9a_ztrailshoe.jpg'>\
                                </div>\
                                <div id='AWA-new-bottom-right' class='col-sm-6 col-md-6 col-lg-6'>\
                                    ...
                                    <ul>\
                                        <li>10mm, 3-layer, FeelLite&trade; sole gives your feet more protection</li>\
                                            <li>Up to 20% lighter than other sandals</li>\
                                    </ul>\
                                    <a id='AWA-more-information' href='#'>more information</a>\
                                </div>\
                            </div>",
        shoeSection:    "<div id='AWA-shoe-section' class='row'>\
                            ...
                            <div class='AWA-shoe col-sm-3 col-md-3 col-lg-3'>\
                                <h5>DIY Xero Shoes Kits</h5>\
                                <p>Make your own barefoot sandals in just minutes!</p>\
                                <img src='//useruploads.visualwebsiteoptimizer.com/useruploads/197399/images/e99018b30e7c9f3ab53fb49ffcafa3ee_cloud.jpg'>\
                                <div class='AWA-shoe-buttons AWA-sb4'>\
                                    <a class='AWA-shoe-button-link AWA-sbl-left' href='http://xeroshoes.com/shop/product-category/diy-kits/'>View <br class='AWA-br'>Men\'s</a>\
                                    <a class='AWA-shoe-button-link AWA-sbl-right' href='http://xeroshoes.com/shop/product-category/diy-kits/'>View <br class='AWA-br'>Women\'s</a>\
                                </div>\
                            </div>\
                        </div>"
    };
	...
	exp.init = function() {
        ...
        $(".primary-features, .stories, .video-introductions, .footer-copy, .newsletter").hide();
