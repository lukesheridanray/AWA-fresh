    ...
    exp.vars = {
        reviewBox:  "<div id='AWA-review-box'>\
                        ...
                        <div id='AWA-left'>\
                            ...
                            <a id='AWA-read-more-reviews' href='http://xeroshoes.com/barefoot-shoe-reviews/' target='_blank'>read more reviews</a>\
                        </div>\
                        <div id='AWA-right'>\
                            <a href='#' id='AWA-scroll'><img id='AWA-right-arrow' src='//useruploads.visualwebsiteoptimizer.com/useruploads/197399/images/60c903da0806ebdecda71809d8d2f7b0_arrow-25-xxl.png'></a>\
                        </div>\
                    </div>",
        ztrek: [
            {
	...
	exp.init = function() {
        ...
        var callback = function() {
            ...
            switch(window.location.pathname) {
                ...
                case "/shop/feeltrue-products/ztrek-men/":
                case "/shop/feeltrue-products/ztrek-women/":
                    reviewArray = exp.vars.ztrek;
                    break;
                case "/shop/amuri/amuri-cloud-mens-barefoot-sandal/":
                case "/shop/amuri/amuri-cloud-womens-barefoot-sandal/":
                case "/shop/feeltrue-products/amuri-cloud-mens-barefoot-sandal/":
                case "/shop/amuri/amuri-cloud-womens-barefoot-sandal/":
                    reviewArray = exp.vars.amuri;
                    break;
                case "/shop/amuri/sensori-venture-mens-barefoot-sandals/":
                case "/shop/amuri/sensori-venture-womens-barefoot-sandals/":
                case "/shop/feeltrue-products/sensori-venture-mens-barefoot-sandals/":
                case "/shop/feeltrue-products/sensori-venture-womens-barefoot-sandals/":
                    reviewArray = exp.vars.sensori;
                case "/shop/diy-kits/diy-feeltrue/":
                    reviewArray = exp.vars.feeltrue;
                default:
                    vwo_$("AWA-review-box").hide();
            }

            // Define insertReviews function
            function insertReviews(position, fade) {
                var num = position || 0;

                if (fade) {
                    vwo_$("#AWA-review").fadeOut(function() {
                      vwo_$(this).text(reviewArray[num].review)
                    }).fadeIn();
                    vwo_$("#AWA-author").fadeOut(function() {
                      vwo_$(this).text(reviewArray[num].author)
                    }).fadeIn();
                    vwo_$("#AWA-read-more-reviews").fadeOut(function() {
                      vwo_$(this).text("read more reviews")
                    }).fadeIn();
                } else {
                    vwo_$("#AWA-review").text(reviewArray[num].review);
                    vwo_$("#AWA-author").text(reviewArray[num].author);
                }
            }

            insertReviews();

            // Scroll through reviews indefinitely on arrow click
            var counter = 1;
            vwo_$("#AWA-scroll").click(function(e) {
                e.preventDefault();
                insertReviews(counter, true);
                counter++;
                if (counter >= reviewArray.length) {
                    counter = 0;
                }
            });
